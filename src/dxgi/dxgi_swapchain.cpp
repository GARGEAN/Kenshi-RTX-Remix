...
namespace dxvk {
  ...
  HRESULT STDMETHODCALLTYPE DxgiSwapChain::Present1(
    ...
    try {
      ...
      if (message.find("VK_ERROR_DEVICE_LOST") != std::string::npos)
        return DXGI_ERROR_DEVICE_REMOVED;
      if (message.find("VK_ERROR_DEVICE_RESET") != std::string::npos)
  ...
  HRESULT STDMETHODCALLTYPE DxgiSwapChain::ResizeBuffers(
          ...
          UINT        SwapChainFlags) {
    KENSHI_DIAGNOSTIC_INFO(str::format("[Remix-DX11][swapdiag] ResizeBuffers count=", BufferCount, " ", Width, "x", Height,
  ...
  HRESULT STDMETHODCALLTYPE DxgiSwapChain::ResizeTarget(const DXGI_MODE_DESC* pNewTargetParameters) {
    if (pNewTargetParameters)
      KENSHI_DIAGNOSTIC_INFO(str::format("[Remix-DX11][swapdiag] ResizeTarget ", pNewTargetParameters->Width, "x",
  ...
  HRESULT STDMETHODCALLTYPE DxgiSwapChain::SetFullscreenState(
          BOOL          Fullscreen,
          IDXGIOutput*  pTarget) {
    KENSHI_DIAGNOSTIC_INFO(str::format("[Remix-DX11][swapdiag] SetFullscreenState Fullscreen=", (int)Fullscreen,
